...
public class Rerank {
	public static void main(String[] args) throws Exception{
		//PrintWriter writer = new PrintWriter("E:/python/NMetamap01.txt", "UTF-8");
		File fout = new File("E:/python/NMetamap2357.txt");
		...
		String file = "E:/Nirali/Nirali/2007/submissions/NLM235.txt";
