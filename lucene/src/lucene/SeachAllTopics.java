...
public class SeachAllTopics {

  private void SearchAllTopics() {}
  ...
  public static void main(String[] args) throws Exception {
    ...
    String queries = null;
    //String queries = "/home/administrator/Documents/Nirali/2007/2007topics.txt";
    int repeat = 0;
    boolean raw = false;
    ...
    while (true) {
      ...
      for (int i = start; i < end; i++) {
        ...
        if (path != null) {
          ...
          System.out.println("200 " + " " + nm + " " + (i+1) + " " + hits[i].score + " " + doc.get("offset") + " " + doc.get("length") + " Lucene1" );
